    ...
    <div class="form-grid-layout">
        ...
        <div class="panel-box box-full">
            ...
            <div class="flex-settings">
                ...
                <div class="form-group"><label>Recytowanie Znaku</label><select name="AnnounceCall"><option value="1" <?php if($vals['AnnounceCall']=='1') echo 'selected'; ?>>TAK</option><option value="0" <?php if($vals['AnnounceCall']=='0') echo 'selected'; ?>>NIE</option></select></div>
            </div>
        </div>
    </div>
